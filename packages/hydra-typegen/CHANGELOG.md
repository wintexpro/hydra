...
* **hydra-processor:** expose extrinsic id in mappings ([a5f6ec8](https://github.com/Joystream/hydra/commit/a5f6ec880861bc050b6e537b006c0a6f49b40e18))
...
* **hydra-indexer:** bump polkadot.api to 6.0.2 ([ca45a62](https://github.com/Joystream/hydra/commit/ca45a622bd790ebac0382ac63b2ae0982c860b9a))
...
* do not return console on gql endpoint when query param is present ([d5bf8fb](https://github.com/Joystream/hydra/commit/d5bf8fbb7aef8eb95855be30e73c56bf59458a33))
...
* **hydra-indexer:** bump polkadot.js version to 5.8.4-4 ([97b8ebd](https://github.com/Joystream/hydra/commit/97b8ebd34a1226e3d26a9a895fa75343cc938fac))
...
* **hydra-cli:** hydra-cli deploy features ([#109](https://github.com/Joystream/hydra/issues/109)) ([3446596](https://github.com/Joystream/hydra/commit/34465964f47dacd56cf0aedd28444d547464e668))
...
* fix inline docs for typegen artifacts ([1395ac1](https://github.com/Joystream/hydra/commit/1395ac126d56c8ddd3abdc42e1e4cb430070ecd9))
...
* update docs, remove unsupported options ([c78b6a2](https://github.com/Joystream/hydra/commit/c78b6a24d5f07191b3f595eab1082e93bbb8bb0c))
...
* save indexer BLOCK_HEIGHT in database ([#94](https://github.com/Joystream/hydra/issues/94)) ([8bc1e40](https://github.com/Joystream/hydra/commit/8bc1e40a8814267067cab28cf73ae2e5eb27e75e))
...
* bump polkadot ([#91](https://github.com/Joystream/hydra/issues/91)) ([1c5afe0](https://github.com/Joystream/hydra/commit/1c5afe02587f2224064bf4943602eb9cf3cbf217))
...
* support connection queries with where conditions on relations ([#83](https://github.com/Joystream/hydra/issues/83)) ([06fd25a](https://github.com/Joystream/hydra/commit/06fd25aafc8e09e926e19502877a0c283138a6fd))
...
* **hydra-indexer:** add default values in case SubstrateExtrinsic properties are undefined (e.g. tip ([3d1dd9b](https://github.com/Joystream/hydra/commit/3d1dd9b84727c10170f0b027c3aa90aa5932a303)), closes [#70](https://github.com/Joystream/hydra/issues/70)
...
## [4.0.0](https://github.com/Joystream/hydra/compare/v3.1.0-alpha.1...v4.0.0) (2021-07-22)


### Features

* **hydra-indexer:** bump polkadot/api indexer version to 4.17.1 ([51ea406](https://github.com/Joystream/hydra/commit/51ea406dbfcb4256e88dba2fb77b0d5d47d67b72))


### Bug Fixes

* **hydra-indexer:** bump polkadot version to 4.15.1 ([7a9ac48](https://github.com/Joystream/hydra/commit/7a9ac484f2475ceab4b9672dea446631c5756b2a))
...
* **hydra-cli:** fix scaffold indexer url property ([db0b721](https://github.com/Joystream/hydra/commit/db0b721a365d1fba4b8101ecdedd3543d3eaaf31))
...
* **hydra-cli:** fix array fields ([bd69623](https://github.com/Joystream/hydra/commit/bd696234387bd49e2b334360206967997e90475d))
